...
export class CombatDirector {
  ...
  setupBattleLine(charA, charB, centerX = 0, centerZ = 0, distance = 4) {
    ...
    // Arm model: lookAt + rotateX(-PI/2) means arm points down by default
    // rotation.x > 0 = arm swings forward/up
    // rotation.x < 0 = arm swings backward
