  ...
  update(t, character) {
    ...
    if (t < 0.35) {
      ...
      if (ht < 0.25) {
        ...
        character.mesh.position.x += dir * ease * 0.08;
      } else {
        const p = (ht - 0.6) / 0.4;
        const ease = p * p;
        ...
        character.mesh.position.x -= dir * (1 - ease) * 0.08;
      }
    }
    // Hit 2: Right cross (0.35-0.7)
      ...
      if (ht < 0.25) {
        ...
        character.mesh.position.x += dir * ease * 0.12;
      } else {
        const p = (ht - 0.6) / 0.4;
        const ease = p * p;
        ...
        character.mesh.position.x -= dir * (1 - ease) * 0.12;
      }
    }
    // Hit 3: Left hook finisher (0.7-1.0)
      ...
      if (ht < 0.2) {
        ...
        character.mesh.position.x -= dir * (1 - ease) * 0.15;
      }
    }
